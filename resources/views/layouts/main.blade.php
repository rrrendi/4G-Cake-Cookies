...
<body data-base="{{ asset('/') }}" class="min-h-screen bg-cream-50 text-cocoa-700 antialiased">
  ...
  <div x-data x-show="$store.konfirmasi.buka" x-cloak class="modal-root grid place-items-center p-4" role="dialog"
    aria-modal="true" aria-labelledby="konfirmasi-judul" @keydown.escape.window="$store.konfirmasi.batal()">
