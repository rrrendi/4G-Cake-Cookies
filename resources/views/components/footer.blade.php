<footer class="mt-20 bg-cocoa-700 text-cream-200">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
    <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
      <div class="lg:col-span-1">
        ...
        <div class="flex items-center gap-3 mb-4">
          <img src="{{ asset('assets/img/logo_4g.png') }}" alt="Logo 4G Cake"
            class="h-10 sm:h-12 w-auto object-contain">
          <span class="font-display font-bold text-white text-[15px] leading-tight">
            4G Cake &amp;<br>Cookies
          </span>
        </div>
        ...
        <div class="flex gap-2 mt-5">
          <a href="#" onclick="toast('Halaman Instagram akan dibuka di fase berikutnya.','info');return false;"
            class="grid place-items-center w-10 h-10 rounded-full bg-white/10 hover:bg-rose-500 transition tap"
            aria-label="Instagram"><i data-lucide="instagram" class="w-4 h-4"></i></a>
          <a href="#" onclick="toast('Chat WhatsApp masih simulasi di prototype ini.','info');return false;"
            class="grid place-items-center w-10 h-10 rounded-full bg-white/10 hover:bg-rose-500 transition tap"
            aria-label="WhatsApp"><i data-lucide="message-circle" class="w-4 h-4"></i></a>
          <a href="#" onclick="toast('Halaman Facebook akan dibuka di fase berikutnya.','info');return false;"
            class="grid place-items-center w-10 h-10 rounded-full bg-white/10 hover:bg-rose-500 transition tap"
            aria-label="Facebook"><i data-lucide="facebook" class="w-4 h-4"></i></a>
        </div>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2.5 text-sm text-cream-200/70">
          ...
          <li><a href="{{ route('order.history') }}" class="hover:text-rose-300 transition">Lacak Pesanan</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2.5 text-sm text-cream-200/70">
          <li class="flex justify-between gap-4"><span>Senin &ndash; Jumat</span><span class="text-cream-200">08.00
              &ndash; 20.00</span></li>
          <li class="flex justify-between gap-4"><span>Sabtu</span><span class="text-cream-200">08.00 &ndash;
              21.00</span></li>
          <li class="flex justify-between gap-4"><span>Minggu</span><span class="text-cream-200">10.00 &ndash;
              17.00</span></li>
    ...
    <div
      class="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-cream-200/50">
